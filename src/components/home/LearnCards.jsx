const cards = [
  {
    image: "https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=600&h=450&fit=crop",
  ...
  {
    image: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=600&h=450&fit=crop",
  ...
  {
    image: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?w=600&h=450&fit=crop",
    ...
    <section className="bg-gray-100 py-16 px-6 md:px-12 lg:px-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {cards.map((card, index) => (
          ...
          >
            <div className={`w-full aspect-[4/3] rounded-xl overflow-hidden mb-6 ${card.bgColor || 'bg-white'}`}>
              <img
                src={card.image}
                alt={card.title}
